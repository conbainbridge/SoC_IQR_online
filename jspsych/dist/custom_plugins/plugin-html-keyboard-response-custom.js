var jsPsychHtmlKeyboardResponseCustom = (function (jspsych) {
  ...
  class HtmlKeyboardResponsePlugin {
      ...
      trial(display_element, trial) {
          var new_html = '<div id="jspsych-html-keyboard-response-stimulus1"><div style="float: left"><p>' + trial.stimulus1 + '</p><p><- Left Arrow</p></div><div style="float: right"><p>' + trial.stimulus2 + "</p><p>Right Arrow -></p></div>";
          // add prompt
